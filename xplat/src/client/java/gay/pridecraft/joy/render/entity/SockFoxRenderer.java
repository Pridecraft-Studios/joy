...
public class SockFoxRenderer extends MobEntityRenderer<CustomFoxEntity.SockFoxEntity, FoxEntityModel<CustomFoxEntity.SockFoxEntity>> {
    private static final Identifier TEXTURE = JoyUtil.id("textures/entity/fox/sock_fox.png");
    private static final Identifier SLEEPING_TEXTURE = JoyUtil.id("textures/entity/fox/sock_fox_sleep.png");
    private static final Identifier SNOW_TEXTURE = JoyUtil.id("textures/entity/fox/snow_sock_fox.png");
    private static final Identifier SLEEPING_SNOW_TEXTURE = JoyUtil.id("textures/entity/fox/snow_sock_fox_sleep.png");
