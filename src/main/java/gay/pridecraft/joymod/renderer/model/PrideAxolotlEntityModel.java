package gay.pridecraft.joymod.renderer.model;
...
public class PrideAxolotlEntityModel<T extends AxolotlEntity & AngledModelEntity> extends AnimalModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData2.addChild(
                "tail", ModelPartBuilder.create().uv(2, 19).cuboid(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 12.0F), ModelTransform.pivot(0.0F, 0.0F, 1.0F)
        );
