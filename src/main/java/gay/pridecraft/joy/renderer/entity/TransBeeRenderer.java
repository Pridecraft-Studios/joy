...
import gay.pridecraft.joy.renderer.model.TransBeeEntityModel;
...
public class TransBeeRenderer extends MobEntityRenderer<CustomBeeEntity.TransBeeEntity, TransBeeEntityModel<CustomBeeEntity.TransBeeEntity>> {
    ...
    public TransBeeRenderer(EntityRendererFactory.Context context) {
        super(context, new TransBeeEntityModel<>(context.getPart(EntityModelLayers.BEE)), 0.4F);
    }
