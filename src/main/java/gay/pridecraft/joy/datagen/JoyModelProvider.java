...
public class JoyModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(JoyItems.SOCK_FOX_SPAWN_EGG, Models.GENERATED);
        itemModelGenerator.register(JoyItems.BII_SPAWN_EGG, Models.GENERATED);
        itemModelGenerator.register(JoyItems.ENBEE_SPAWN_EGG, Models.GENERATED);
        itemModelGenerator.register(JoyItems.TRANS_BEE_SPAWN_EGG, Models.GENERATED);
        itemModelGenerator.register(JoyItems.FROG_SPAWN_EGG, Models.GENERATED);
        itemModelGenerator.register(JoyItems.SNIFFER_SPAWN_EGG, Models.GENERATED);
